__author__ = 'Matty'
# shamelessly copied and modified from http://michelleminkoff.com/2011/02/01/making-the-structured-usable-transform-json-into-a-csv/
...
outfile_path='C:/Users/Matty/Desktop/Output/file.csv'

# open it up, the w means we will write to it
writer = csv.writer(open(outfile_path, 'w'))

#create a list with headings for our columns
headers = ['airbnbid', 'nightly_price', 'monthly_price', 'start', 'min_night', 'roomtype', 'bathrooms', 'description', 'proptype', 'occupancy', 'bedrooms', 'last_updated', 'url', 'lat', 'long']
